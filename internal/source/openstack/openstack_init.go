...
func (oss *OpenStackSource) initServers(ctx context.Context) error {
...
func (oss *OpenStackSource) initFlavors(ctx context.Context) error {
...
func (oss *OpenStackSource) initNetworks(ctx context.Context) error {
...
func (oss *OpenStackSource) initVolumes(ctx context.Context) error {
...
func (oss *OpenStackSource) initImages(ctx context.Context) error {
