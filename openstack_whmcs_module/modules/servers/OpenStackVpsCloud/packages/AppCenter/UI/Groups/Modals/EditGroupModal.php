...
use ModulesGarden\OpenStackVpsCloud\Packages\AppCenter\UI\Groups\Forms\EditGroupForm;

class EditGroupModal extends ModalEdit implements AdminAreaInterface, AjaxComponentInterface
{
    public function loadHtml(): void
    {
        ...
        $this->addElement(new EditGroupForm());
    }
}