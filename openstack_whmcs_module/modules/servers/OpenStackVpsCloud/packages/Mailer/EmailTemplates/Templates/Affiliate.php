...
use ModulesGarden\OpenStackVpsCloud\Core\WHMCS\Models\Affiliate as AffiliateModel;

class Affiliate extends AbstractEmailTemplate
{
    public function getRecipient(): Recipient
    {
        $affiliate = AffiliateModel::findOrFail($this->relId);
        return Recipient::createFromClient($affiliate->clientid);
    }
}