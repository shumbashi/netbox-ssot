...
class NetworkSettings extends Form implements AdminAreaInterface
{
    ...
    public function loadHtml(): void
    {
        ...
        $this->builder->addField((new Dropdown())->setName('customconfigoption[fixed_network]'));
        $this->builder->addField((new Dropdown())->setName('customconfigoption[floating_network]'));
        $this->builder->addField((new Number())->setName('customconfigoption[ips]'));
        $this->builder->addField((new Switcher())->setName('customconfigoption[single_interface]'), true);
    }
}