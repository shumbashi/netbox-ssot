...
use ModulesGarden\OpenStackVpsCloud\App\UI\Client\Firewall\Modals\AddFirewallRuleModal;
...
class AddFirewallRuleButton extends ButtonCreate implements ClientAreaInterface, AdminAreaInterface
{
    public function loadHtml(): void
    {
        $this->setDisabled(JobManager::areCirticalBeingPerformed(Params::get('serviceid')));
        $this->onClick((new ModalLoad(new AddFirewallRuleModal())));
    }
}