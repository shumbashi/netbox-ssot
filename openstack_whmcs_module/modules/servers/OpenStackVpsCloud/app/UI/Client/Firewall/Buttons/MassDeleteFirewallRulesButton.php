...
use ModulesGarden\OpenStackVpsCloud\App\UI\Client\Firewall\Modals\MassDeleteFirewallRulesModal;
...
class MassDeleteFirewallRulesButton extends IconButtonDelete implements ClientAreaInterface, AdminAreaInterface
{
    public function loadHtml(): void
    {
        $this->setDisabled(JobManager::areCirticalBeingPerformed(Params::get('serviceid')));
        $this->onClick((new ModalLoad(new MassDeleteFirewallRulesModal())));
