...
use ModulesGarden\OpenStackVpsCloud\App\UI\Client\Snapshots\Modals\MassDeleteSnapshotModal;
...
class MassDeleteSnapshotButton extends IconButtonDelete implements ClientAreaInterface, AdminAreaInterface
{
    public function loadHtml(): void
    {
        $this->setDisabled(JobManager::areCirticalBeingPerformed(Params::get('serviceid')));
        $this->onClick((new ModalLoad(new MassDeleteSnapshotModal())));
