...
use ModulesGarden\OpenStackVpsCloud\App\UI\Client\Backups\Modals\MassDeleteBackupsModal;
...
class MassDeleteBackupsButton extends IconButtonDelete implements AdminAreaInterface, ClientAreaInterface
{
    public function loadHtml(): void
    {
        $this->setDisabled(JobManager::areCirticalBeingPerformed(Params::get('serviceid')));
        $this->onClick((new ModalLoad(new MassDeleteBackupsModal())));
