...
use ModulesGarden\OpenStackVpsCloud\App\UI\Client\Backups\Modals\MassChangeProtectionStatusModal;
...
class MassChangeProtectionStatusButton extends IconButton implements AdminAreaInterface, ClientAreaInterface
{
    public function loadHtml(): void
    {
        $this->setIcon('cog');
        $this->setDisabled(JobManager::areCirticalBeingPerformed(Params::get('serviceid')));
        $this->onClick((new ModalLoad(new MassChangeProtectionStatusModal())));
        $this->displayWithTitle($this->translate('title'));
    }
}