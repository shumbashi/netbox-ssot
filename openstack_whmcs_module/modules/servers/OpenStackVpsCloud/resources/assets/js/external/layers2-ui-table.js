        ...
        (function (factory) {
            ...
            var DataTable = function DataTable(options) {
                ...
                this.each(function () {
                    ...
                    _fnMap(oSettings, oInit, [
                        "asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", "rowId", ["iCookieDuration", "iStateDuration"], // backwards compat
            ...
            DataTable.defaults = {
                ...
                "oLanguage": {
                    ...
                    "oPaginate": {
                        /**
                         * FormInputText to use when using the 'full_numbers' type of pagination for the
                        ...
                        /**
                         * FormInputText to use for the 'next' pagination button (to take the user to the
                         * next page).
                         *  @type string
                         *  @default Next
                         *
                        ...
                        /**
                         * FormInputText to use for the 'previous' pagination button (to take the user to
                         * the previous page).
                         *  @type string
                         *  @default Previous
                         *
                    ...
                    /**
                     * FormInputText which is displayed when the table is processing a user action
                    ...
                    /**
                     * FormInputText shown inside the table records when the is no information to be
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        (function (factory) {
            ...
            $.extend(Buttons.prototype, {
                 ...
                 * @param  {string} label FormInputText
                 * @return {Buttons} Self for chaining
                 */
