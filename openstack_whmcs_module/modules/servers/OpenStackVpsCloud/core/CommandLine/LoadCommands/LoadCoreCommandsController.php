...
/**
 * Class LoadCoreCommandsController
 *
 * Loads command controllers from the module's core directory.
 * Implements LoadCommandsControllersInterface to discover and provide core command classes.
 *
...
{
    /**
     * Get an array of command class names from the module's core directory.
     *
     * @param string|null $dir The subdirectory within core to search for commands
    ...
    /**
     * Get PHP files from the specified directory within the core folder.
     *
     * @param string $dir The subdirectory within core to scan
